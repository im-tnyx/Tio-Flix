# Contributor Covenant Code of Conduct (Tio-Flix)

## Our Pledge

We want **Tio-Flix** to be a welcoming, professional, and useful space for everyone contributing to the project.
...
For Tio-Flix, architecture-sensitive discussions should refer directly to:
...
- community chat or planning spaces related to Tio-Flix
- any public or private interaction where someone is representing the project

---

## Reporting

If you experience or witness unacceptable behavior, report it to the project maintainers or repository owner.

When reporting, include as much context as you safely can:
...
Reports will be handled with care. Maintainers should protect privacy and avoid unnecessary escalation.
...
Tio-Flix is an OTT/movie streaming product. The code should be reliable, the content boundary should remain legal, and the community around it should feel steady too.
